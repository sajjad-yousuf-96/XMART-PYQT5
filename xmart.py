...
"font: 10.87pt \"Times New Roman\";")
    ...
    def retranslateUi(self, mart):
        ...
        mart.setWindowTitle(_translate("mart", "XMART"))
        ...
        self.label.setText(_translate("mart", "XMART"))
        ...
        self.label_2.setText(_translate("mart", "XMART"))
        self.Employee.setText(_translate("mart", "EMPLOYEE"))
        ...
        self.lineEdit_5.setInputMask(_translate("mart", "Customer"))
        ...
        self.label_6.setText(_translate("mart", "XMART BILLING"))
        self.lineEdit_13.setPlaceholderText(_translate("mart", "Salary"))
        self.Employee_3.setText(_translate("mart", "EMPLOYEE"))
        ...
        self.pushButton_13.setText(_translate("mart", "ADD EMPLOYEE"))
        ...
        self.pushButton_16.setText(_translate("mart", "DELETE"))
        ...
        self.label_7.setText(_translate("mart", "XMART INVENTORY"))
        ...
        ###   BUTTON CONNECTED    ####
        self.Employee.clicked.connect(lambda:self.stackedWidget.setCurrentIndex(3))
        self.Inventory.clicked.connect(lambda:self.stackedWidget.setCurrentIndex(4))
        self.Inventory_3.clicked.connect(lambda:self.stackedWidget.setCurrentIndex(4))
        ...
        self.Employee_4.clicked.connect(lambda:self.stackedWidget.setCurrentIndex(3))
...
########################
    ...
    def delinv(self):
        ...
        try:
            conn = sqlite3.connect('xmart.db')
            cursor = conn.cursor()
            sql = ('DELETE FROM INVENTORY WHERE PR_ID = ?')
...
######     EMPLOYEEE ADDING DELETE    #############
    def addemp(self):
        ...
        if self.radioButton.isChecked():
            ...
            a="GUARD"
        try:
            if eid and ena and esal != "":
                conn = sqlite3.connect('xmart.db')
                cursor = conn.cursor()
                sql = ("INSERT INTO EMPLOYEE(ID,NAME,DESIGNATION,SALARY) VALUES(?,?,?,?);")
                cursor.execute(sql,(eid,ena,a,esal))
                conn.commit()
                conn.close()
    ...
    def sales(self):
        try:
            ...
            c.drawString(85,60,name)
            c.drawString(85,70,date)
            conn = sqlite3.connect('xmart.db')
            cursor = conn.cursor()
...
##            print(self.lcdNumber.intValue())
    ...
    def pdf(self):
        try:
            global c
            c = canvas.Canvas("xmart.pdf",pagesize=(200,250),bottomup=0)
            c.translate(10,40)
            c.scale(1,-1)
#            c.drawImage("XMART-01.png",0,0,width=50,height=30)
            ...
            c.drawCentredString(125,20,"XMART")
            c.line(70,22,180,22)

            c.setFont("Helvetica-Bold",5)
            c.drawCentredString(125,30,"SHOP NO 4, JETPUR PLAZA,DHORAJI,KARACHI")
            c.drawCentredString(125,35,"KARACHI-PAKISTAN")
            c.line(5,45,195,45)
            ...
            c.drawString(20,230,"MADE BY MSY SOFTWARES")
